      ...
      children: [
        ...
        FadeInDown(
          ...
          child: SizedBox(
            ...
            child: Text(
              'I am dedicated to establishing a fulfilling career within an organization'
                  ' that shares my commitment to innovation and values. With a passion for'
                  ' software development and a strong work ethic, I aspire to   contribute my'
                  ' skills and expertise while continuously expanding my knowledge. My goal is'
                  ' to collaborate with  a dynamic team to create cutting-edge solutions, drive'
                  ' growth, and align with the company values to achieve mutual success.',
